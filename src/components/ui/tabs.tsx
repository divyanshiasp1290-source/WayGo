...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-full bg-[#eff5ff] p-1 text-slate-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] border border-blue-100/80",
      className,
    )}
    {...props}
  />
